...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{ asset('style/image/mymovie.png ')}}">
        ...
        <header class="header_area">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="navbar-brand logo_h" href="/"><img src="{{ asset('style/image/Logom.png ') }}" alt="" width="100" height="50"></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item {{ request()->is('nowplaying') ? 'active': '' }}"><a class="nav-link" href="{{Route('nowplaying')}}">Now Playing</a></li>
                            <li class="nav-item {{ request()->is('upcoming') ? 'active': '' }}"><a class="nav-link" href="{{Route('upcoming')}}">Upcoming</a></li>
                            <li class="nav-item {{ request()->is('theaters') ? 'active': '' }}"><a class="nav-link" href="{{Route('theaters')}}">Theaters</a></li>
                            <li class="nav-item s"><a class="nav-link" href="@guest
                                /login
                                @else 
                                /
                                @endguest">Get Tickets</a></li>
                        </ul>
                    </div> 
                </nav>
            </div>
        ...
        <footer class="footer-area section_gap">
            <div class="container">
                ...
                <div class="row footer-bottom d-flex justify-content-between align-items-center">
                    <p class="col-lg-8 col-sm-12 footer-text m-0">MyMovie Copyright @2021</p>
                    <div class="col-lg-4 col-sm-12 footer-social">
                        <a href="#"><i class="">About Us</i></a>
                        <a href="#"><i class="">FAQ</i></a>
                        <a href="#"><i class="">Join Us</i></a>
                    </div>
                </div>
            </div>
        </footer>
