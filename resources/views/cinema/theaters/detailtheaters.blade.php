 ...
 <section class="breadcrumb_area">
    ...
    <div class="container">
        <div class="page-cover text-center">
            <h2 class="page-cover-tittle">DETAILS THEATER</h2>
            <ol class="breadcrumb">
                <li><a href="index.html">THEATER</a></li>
                <li class="active">DETAIL THEATER</li>
            </ol>
        </div>
    </div>
</section>
                ...
                <section class="button-area">
                    ...
                    <form action="{{ url('datamovie/' .$daftar_movies->id)}}" method="post">
                        <div>
                            ...
                            <h4><b>TIME = </b>{{$daftar_movies->movieRealtime}}</h4>
                    ...
                    <div class="container border-top-generic">
                        <div class="button-group-area mt-30">
                            <a href="https://www.youtube.com/watch?v=fHbxkAmjMbU"target="_blank" class="genric-btn primary radius">Trailer</a>
                            <a href="#" target="_blank" class="genric-btn primary radius">Choose theater</a>
                        </div>
                    </div>
                </section>
            </div>
